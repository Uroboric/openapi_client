...
class RESTClientObject:
    ...
    async def request(self, method, url, headers=None, body=None, post_params=None, _request_timeout=None):
        ...
        return await self._logged_requests(pool_manager, **args)

    async def _logged_requests(self, pool_manager, **args) -> RESTResponse:
        ...
        try:
            ...
            if data:
                ...
                content = (
                    json.dumps(json_data, indent=4) if attachment_type == allure.attachment_type.JSON else json_data
                )
                allure.attach(json.dumps(content, indent=4), name="response", attachment_type=attachment_type)
